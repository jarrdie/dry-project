...
import dry.toolbox.jdk.util.function.AdultPersonCheck;
import dry.toolbox.jdk.util.function.PersonCheck;
import dry.toolbox.jdk.util.function.Person;
import static dry.toolbox.jdk.util.function.Person.Sex.*;
import static dry.toolbox.jdk.util.function.Person.*;
import static dry.toolbox.jdk.util.function.Person.Sex.*;
import java.time.*;
import java.util.*;
